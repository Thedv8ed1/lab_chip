...
const double notes[] = {261.63,293.66,329.63,349.23, 392.0, 440.0,493.88,523.25};

enum States {OFF,OFFPRESSED,ON,ONPRESSED}state;
unsigned char note;
void Tick(){
	switch(state){
		case OFFPRESSED:
		...
		case ONPRESSED:
		case ON: set_PWM(notes[note]);break;
	}
}
void TickInput(){
	switch(state){
